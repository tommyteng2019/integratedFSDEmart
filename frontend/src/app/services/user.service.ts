...
export class UserService {
    ...
    login(loginForm): Observable<JwtResponse> {
        ...
        const url = `/api/microservice-user/login`;
    ...
    signUp(user: User): Observable<User> {
        ...
        const url = `/api/microservice-user/register`;
        return this.http.post<User>(url, user);
    }

    update(user: User): Observable<User> {
        //const url = `${apiUrl}/profile`;
        const url = `/api/microservice-user/profile`;
        return this.http.put<User>(url, user);    }

    get(email: string): Observable<User> {
        //const url = `${apiUrl}/profile/${email}`;
        const url = `/api/microservice-user/profile/customer1@email.com`;
