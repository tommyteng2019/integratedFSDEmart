...
import com.tommy.fsd.security.JWT.JwtProvider;
import com.tommy.fsd.service.UserService;
import com.tommy.fsd.vo.request.LoginForm;
import com.tommy.fsd.vo.response.JwtResponse;
   ...
   @PostMapping("/login")
    public ResponseEntity<JwtResponse> login(@RequestBody LoginForm loginForm) {
        ...
        try {
            ...
            String jwt = jwtProvider.generate(user);
    ...
    public ResponseEntity<User> getProfile(@PathVariable("email") String name) {
